...
public interface ItemRequirementCT<T> extends RecipeCTBuilder<T> {
    ...
    default T requireItem(IItemStack stack, @OptionalString String slot) {
        return addRequirement(new ItemRequirement(RequirementIOMode.INPUT, new ItemIngredient(stack.getDefinition()), stack.getAmount(), CTUtils.nbtFromStack(stack), slot));
    }
    ...
    default T produceItem(IItemStack stack, @OptionalString String slot) {
        return addRequirement(new ItemRequirement(RequirementIOMode.OUTPUT, new ItemIngredient(stack.getDefinition()), stack.getAmount(), CTUtils.nbtFromStack(stack), slot));
    }
}
