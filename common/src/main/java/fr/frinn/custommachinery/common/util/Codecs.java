...
public class Codecs {
    ...
    public static final Codec<ResourceLocation> ITEM_MODEL_CODEC  = either(RegistrarCodec.ITEM, RESOURCE_LOCATION_CODEC, "Item Model").xmap(either -> either.map(Registry.ITEM::getKey, Function.identity()), Either::right);
