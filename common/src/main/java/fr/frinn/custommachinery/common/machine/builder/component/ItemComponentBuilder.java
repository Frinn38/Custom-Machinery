...
public class ItemComponentBuilder implements IMachineComponentBuilder<ItemMachineComponent> {
    ...
    public IMachineComponentTemplate<ItemMachineComponent> build() {
        return new ItemMachineComponent.Template(id.get(), mode.get(), capacity.get(), capacity.get(), capacity.get(), new ArrayList<>(), false, DefaultItemComponentVariant.INSTANCE, null);
    }
}
