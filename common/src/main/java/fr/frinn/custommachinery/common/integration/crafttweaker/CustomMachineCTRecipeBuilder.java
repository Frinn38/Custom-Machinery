...
public class CustomMachineCTRecipeBuilder {
    ...
    @Method
    public CustomMachineCTRecipeBuilder requireFluid(Fluid fluid, long amount, @Optional IData data, @OptionalString String tank) {
        return withFluidRequirement(RequirementIOMode.INPUT, new FluidIngredient(fluid), amount, false, getNBT(data), tank);
    }

    @Method
    public CustomMachineCTRecipeBuilder requireFluidTag(MCTag tag, long amount, @Optional IData data, @OptionalString String tank) {
        try {
    ...
    @Method
    public CustomMachineCTRecipeBuilder produceFluid(Fluid fluid, long amount, @Optional IData data, @OptionalString String tank) {
        return withFluidRequirement(RequirementIOMode.OUTPUT, new FluidIngredient(fluid), amount, false, getNBT(data), tank);
    }

    @Method
    public CustomMachineCTRecipeBuilder requireFluidPerTick(Fluid fluid, long amount, @Optional IData data, @OptionalString String tank) {
        return withFluidRequirement(RequirementIOMode.INPUT, new FluidIngredient(fluid), amount, true, getNBT(data), tank);
    }
    ...
    @Method
    public CustomMachineCTRecipeBuilder produceFluidPerTick(Fluid fluid, long amount, @Optional IData data, @OptionalString String tank) {
        return withFluidRequirement(RequirementIOMode.OUTPUT, new FluidIngredient(fluid), amount, true, getNBT(data), tank);
    }
    ...
    public CustomMachineCTRecipeBuilder biomeWhitelist(Biome[] biomes) {
        List<ResourceLocation> biomesID = Arrays.stream(biomes).map(this::biomeID).toList();
        return addRequirement(new BiomeRequirement(biomesID, false));
    }

    @Method
    public CustomMachineCTRecipeBuilder biomeWhitelist(Biome biome) {
        return addRequirement(new BiomeRequirement(Collections.singletonList(this.biomeID(biome)), false));
    }
    ...
    public CustomMachineCTRecipeBuilder biomeBlacklist(Biome biome) {
        return addRequirement(new BiomeRequirement(Collections.singletonList(this.biomeID(biome)), true));
    }
    ...
    private ResourceLocation biomeID(Biome biome) {
    ...
    private CustomMachineCTRecipeBuilder withFluidRequirement(RequirementIOMode mode, IIngredient<Fluid> fluid, long amount, boolean isPerTick, CompoundTag nbt, String tank) {
        if(isPerTick) {
