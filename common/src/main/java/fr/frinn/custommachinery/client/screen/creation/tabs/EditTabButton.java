...
public class EditTabButton extends TabButton {
    ...
    public void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ResourceLocation texture = new ResourceLocation(CustomMachinery.MODID, "textures/gui/creation/tab_button.png");
        graphics.blitNineSliced(texture, this.getX(), this.getY(), this.width, this.height, 4, 4, 4, 4, 28, 32, this.isSelected() ? 28 : 0, 0);
