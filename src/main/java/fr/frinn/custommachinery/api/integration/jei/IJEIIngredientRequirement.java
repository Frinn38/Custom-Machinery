 ...
 * Ingredients supported by jei are {@link ItemStack} and {@link net.neoforged.neoforge.fluids.FluidStack}. CM also add {@link fr.frinn.custommachinery.impl.integration.jei.Energy} and {@link fr.frinn.custommachinery.impl.integration.jei.Experience}.
...
public interface IJEIIngredientRequirement<T> {
     ...
     */
    List<IJEIIngredientWrapper<T>> getJEIIngredientWrappers(IMachineRecipe recipe, RecipeRequirement<?, ?> requirement);
}
