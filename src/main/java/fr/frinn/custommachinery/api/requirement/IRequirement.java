 ...
 * @param <C> The component this requirement will use.
 */
public interface IRequirement<C extends IMachineComponent> {
     ...
     */
    MachineComponentType<C> getComponentType();
    ...
    /**
     * This method is called by the {@link fr.frinn.custommachinery.api.crafting.IProcessor} when a recipe containing this requirement is found suitable to be processed.
     * Inside this method you must pass every {@link fr.frinn.custommachinery.api.crafting.IRequirementList.RequirementFunction} that the processor must check or process.
     * @param list An {@link IRequirementList} used to collect every {@link fr.frinn.custommachinery.api.crafting.IRequirementList.RequirementFunction} that the processor must check or process for this requirement.
     */
     ...
     * Note: The {@link DisplayInfoTemplate} returned by {@link RecipeRequirement#info} (if present) will take priority
