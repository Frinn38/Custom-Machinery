...
public class MachineLoadingScreen extends Screen {
    ...
    protected void init() {
        ...
        this.saveButton = this.addButton(new Button(
                ...
                StringTextComponent.EMPTY,
                (button) -> this.save(),
                (button, matrix, mouseX, mouseY) -> this.renderTooltip(matrix, new TranslationTextComponent("custommachinery.gui.machineloading.save"), mouseX, mouseY)
        ));
        this.deleteButton = this.addButton(new TexturedButton(
                ...
                (button) -> this.delete(),
                (button, matrix, mouseX, mouseY) -> this.renderTooltip(matrix, new TranslationTextComponent("custommachinery.gui.machineloading.delete"), mouseX, mouseY)
        ));
    ...
    private void save() {
        ...
        if(machineToSave != null && machineToSave.getId() != null) {
    ...
    private void delete() {
        ...
        if(machineToDelete != null) {
            CustomMachinery.MACHINES.remove(machineToDelete.getId());
