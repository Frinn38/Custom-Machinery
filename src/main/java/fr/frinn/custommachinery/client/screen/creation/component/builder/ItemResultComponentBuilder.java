...
public class ItemResultComponentBuilder extends ItemComponentBuilder {
    ...
    public static class ItemResultComponentBuilderPopup extends ItemComponentBuilderPopup {
        ...
        public Template makeTemplate() {
            return new ResultItemMachineComponent.Template(this.id.getValue(), this.mode.getValue(), this.capacity.intValue(), Optional.of(this.maxInput.intValue()), Optional.of(this.maxOutput.intValue()), Collections.emptyList(), false, Optional.of(this.mode.getValue().getBaseConfig()), this.locked.selected());
        }
    }
}
