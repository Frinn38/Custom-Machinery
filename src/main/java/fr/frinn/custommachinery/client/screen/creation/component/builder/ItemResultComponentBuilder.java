...
public class ItemResultComponentBuilder extends ItemComponentBuilder {
    ...
    public static class ItemResultComponentBuilderPopup extends ItemComponentBuilderPopup {
        ...
        public Template makeTemplate() {
            return new ResultItemMachineComponent.Template(this.id.getValue(), this.mode.getValue(), this.capacity.intValue(), this.maxInput.intValue(), this.maxOutput.intValue(), this.filter, this.config, this.locked.selected());
        }
    }
}
