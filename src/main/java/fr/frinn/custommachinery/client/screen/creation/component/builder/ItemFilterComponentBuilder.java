...
public class ItemFilterComponentBuilder extends ItemComponentBuilder {
    ...
    public static class ItemFilterComponentBuilderPopup extends ItemComponentBuilderPopup {
        ...
        public Template makeTemplate() {
            return new FilterItemMachineComponent.Template(this.id.getValue(), this.mode.getValue(), this.capacity.intValue(), this.maxInput.intValue(), this.maxOutput.intValue(), this.filter, this.config, this.locked.selected());
        }
    }
}
