...
public class RenderTypes extends RenderType {
    ...
    public static final RenderType NOPE = create("nope", DefaultVertexFormat.BLOCK, Mode.QUADS, 2097152, true, false, RenderType.CompositeState.builder().setShaderState(RENDERTYPE_TRANSLUCENT_SHADER).setTransparencyState(RenderStateShard.TRANSLUCENT_TRANSPARENCY).setLightmapState(LIGHTMAP).setTextureState(BLOCK_SHEET_MIPPED).setDepthTestState(LEQUAL_DEPTH_TEST).createCompositeState(true));
