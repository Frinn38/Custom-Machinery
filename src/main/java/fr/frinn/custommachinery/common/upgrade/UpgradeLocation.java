...
public record UpgradeLocation(Identifier id, MachineLocation.Loader loader, String packName, FileTime created, FileTime modified) {
    ...
    public static final NamedCodec<UpgradeLocation> CODEC = NamedCodec.record(upgradeLocationInstance ->
            upgradeLocationInstance.group(
                    DefaultCodecs.IDENTIFIER.fieldOf("id").forGetter(UpgradeLocation::id),
    ...
    public UpgradeLocation(Identifier id, MachineLocation.Loader loader, String packName, @Nullable FileTime created, @Nullable FileTime modified) {
        this.id = id;
        this.loader = loader;
    ...
    public static UpgradeLocation fromLoader(MachineLocation.Loader loader, Identifier id, String packName, @Nullable FileTime created, @Nullable FileTime modified) {
    ...
    public static UpgradeLocation fromDefault(Identifier id, String packName) {
        return new UpgradeLocation(id, MachineLocation.Loader.DEFAULT, packName, null, null);
    }

    public static UpgradeLocation fromDatapack(Identifier id, String packName, @Nullable FileTime created, @Nullable FileTime modified) {
    ...
    public static UpgradeLocation fromDatapackZip(Identifier id, String packName, @Nullable FileTime created, @Nullable FileTime modified) {
        return new UpgradeLocation(id, MachineLocation.Loader.DATAPACK_ZIP, packName, created, modified);
    }

    public static UpgradeLocation fromKubeJS(Identifier id, String packName, @Nullable FileTime created, @Nullable FileTime modified) {
        return new UpgradeLocation(id, MachineLocation.Loader.KUBEJS, packName, created, modified);
    }

    public static UpgradeLocation fromKubeJSScript(Identifier id, String packName) {
    ...
    @Nullable
    public static File getFile(MinecraftServer server, Identifier id, MachineLocation.Loader loader, String packName) {
