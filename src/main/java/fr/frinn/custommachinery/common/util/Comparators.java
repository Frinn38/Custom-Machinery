...
public class Comparators {
    ...
    public static final Comparator<RecipeRequirement<?, ?>> REQUIREMENT_COMPARATOR = Comparator.comparing(requirement -> requirement.requirement().getType() == CMRegistration.COMMAND_REQUIREMENT.get() ? 1 : -1);
