...
public class CustomMachineDamageSource extends DamageSource {
    ...
    public CustomMachineDamageSource(MachineTile machine) {
        super(machine.getComponentManager().getLevel().registryAccess().getOrThrow(ResourceKey.create(Registries.DAMAGE_TYPE, CustomMachinery.rl("custom_machine_damage"))));
