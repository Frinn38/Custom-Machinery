...
public class StatusGuiElement extends AbstractTexturedGuiElement {
    ...
    public static final ResourceLocation BASE_STATUS_IDLE_TEXTURE = CustomMachinery.rl("textures/gui/base_status_idle.png");
    public static final ResourceLocation BASE_STATUS_RUNNING_TEXTURE = CustomMachinery.rl("textures/gui/base_status_running.png");
    public static final ResourceLocation BASE_STATUS_ERRORED_TEXTURE = CustomMachinery.rl("textures/gui/base_status_errored.png");
