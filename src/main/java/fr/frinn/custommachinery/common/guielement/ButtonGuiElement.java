...
public class ButtonGuiElement extends AbstractTexturedGuiElement {
    ...
    public static final TextureInfo BASE_TEXTURE = CustomMachinery.texture("textures/gui/base_button.png");
    public static final TextureInfo BASE_TEXTURE_HOVERED = CustomMachinery.texture("textures/gui/base_button_hovered.png");
    public static final TextureInfo BASE_TEXTURE_TOGGLE = CustomMachinery.texture("textures/gui/base_button_toogle.png");
    public static final TextureInfo BASE_TEXTURE_TOGGLE_HOVERED = CustomMachinery.texture("textures/gui/base_button_toogle_hovered.png");
    ...
    public ButtonGuiElement(Properties properties, TextureInfo textureToggle, TextureInfo textureToggleHovered, boolean toggle, Component text, ItemStack item, int holdTime) {
        super(properties);
